...
class ModeOfPaymentController extends Controller
{
   ...
   public function fetchPaymentTypeByShopTransactionId($id)
    ...
    public function fetchPaymentTypeByShopTransactionIdV2($id)
    {
        return response()->json(app(\App\Services\ShopOrderPaymentService::class)->fetch($id));
    }
    ...
    public function store(Request $request)
    {
        ...
        $fetchBalance = $this->fetchPaymentTypeByShopTransactionIdV2($request->input('shop_order_transaction_id'))->getData(true);
